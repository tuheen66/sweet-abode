const AboutUs = () => {
  return (
    <div className="mb-8 bg-pink-100 px-8 py-4 rounded-xl shadow-2xl">
      ...
      <div>
        <div className="grid lg:grid-cols-2 lg:gap-12 aboutUs">
          <div>
            <p>
              Welcome to <span className="font-bold">Sweet Abode</span>
            </p>
            <p>
              At <span className="font-bold">Sweet Abode</span>, we are
              dedicated to helping you find your dream home or perfect
              investment property. With a commitment to excellence and a passion
              for real estate, we strive to provide exceptional service and
              unparalleled market knowledge.
            </p>
            <h4>Our Story</h4>
            <p>
              Founded in 2000, <span className="font-bold">Sweet Abode</span>{" "}
              has grown from a small local agency to one of the leading real
              estate companies in New York City, New York. Our journey is marked by
              a relentless pursuit of client satisfaction and a deep-rooted
              belief in the value of home ownership.
            </p>
            <h4>Our Values</h4>
            <p>
          ...
          <div>
            ...
            <p>Stay informed with our latest market reports and insights.</p>
          </div>
        </div>
      </div>
    </div>
